...
We started by establishing the basic tools to generate images and handle 3D math.
...
We defined "sight" by creating rays and a background gradient.
...
We introduced solid geometry using mathematical intersection.
...
We moved away from hard-coded math in `main.cpp` to a flexible, object-oriented system.
